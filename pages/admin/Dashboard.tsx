...
const Dashboard = () => {
    ...
    const stats = [
        { label: "Total Submissions", value: totalSubmissions, icon: Package, color: "bg-blue-100 text-blue-600", trend: "+12%" },
        { label: "Active Users", value: totalUsers, icon: Users, color: "bg-emerald-100 text-emerald-600", trend: "+5%" },
        { label: "Credits Awarded", value: totalCredits, icon: Coins, color: "bg-amber-100 text-amber-600", trend: "+8%" },
        { label: "Collection Points", value: activePoints, icon: MapPin, color: "bg-purple-100 text-purple-600", trend: "Stable" },
    ];
        ...
        <div>
                ...
                {stats.map((stat, i) => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mt-1"><AnimatedCounter to={stat.value} /></h3>
                        </div>
                    </motion.div>
                ))}
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
                <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                    <h3 className="text-lg font-bold text-slate-900 mb-6">Weekly Submissions Activity</h3>
                    ...
                    {activityLogs.slice(0, 5).map((log) => (
                        <div key={log.id} className="p-4 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-slate-500">{log.details} by {log.adminName}</p>
                            </div>
